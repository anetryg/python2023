...
""" Vytvořte program, který na první řá0dek vypíše "Divadlo AhojAhoj", na druhý řádek "Vítejte v online rezervaci vstupenek" a na třetí řádek "Pro vstup do systému je potřeba registrace". Poté získejte od uživatele uživatelské jméno a věk. """

#**Úkol 5: Cena vstupenky**

""" Při zpracování programu `vstupenky01.py` vytvořte novou verzi `vstupenky02.py`. Vytvořte proměnnou `plna_cena` s hodnotou 12. Podle věku uživatele vypočítejte cenu vstupenky s následujícími pravidly: 0 euro pro návštěvníky mladší 6 let, 65% základní ceny pro návštěvníky 6 až 26 let, 100% základní ceny pro návštěvníky 27 až 64 let a 50% základní ceny pro ostatní. Zaokrouhlete cenu na celé centy. """
...
""" Napište program, který bude ověřovat platnost e-mailové adresy. Požádejte uživatele, aby zadal svou e-mailovou adresu. Zkontrolujte, zda adresa obsahuje znak "@" a alespoň jeden "." po "@" (takový formát je typický pro e-mailové adresy). Pokud adresa splňuje podmínky, vypište "E-mailová adresa je platná." Jinak vypište "Neplatná e-mailová adresa." """
