...
#Úkol 5
""" Vytvoř třídu Player, která reprezentuje sportovce. Třída by měla mít atributy name (jméno hráče), sport (typ sportu, který hráč provozuje) a score (skóre nebo výkonnost hráče). Přidej metodu update_score(points), která aktualizuje skóre hráče o zadaný počet bodů."""

#Úkol 6
""" Navrhněte třídu Team s atributy name (jméno týmu) a players (seznam hráčů ve týmu). Přidej metodu add_player(player), která přidá hráče do týmu, a metodu print_players(), která vypíše seznam hráčů ve týmu. """