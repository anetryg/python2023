...
#Úkol 2
"""Vytvořte program, který načte obsah existujícího textového souboru a zobrazí prvních 10 řádků. Ošetřte možné chyby, například pokud soubor neexistuje."""



#Úkol 3
"""Napište program, který umožní uživateli zadat název existujícího textového souboru a poté vypíše, zda je soubor prázdný nebo ne. """
